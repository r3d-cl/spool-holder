...
create_base(base_width,small_cylinder_diam,max_cylinder_diam);
//create_washer(washer_width,main_cylinder_diam,small_cylinder_diam);
//half_roller(max_cylinder_diam,small_cylinder_diam,fit_cube_length,fit_cube_width,base_width,washer_width,first_layer_tolerance);
